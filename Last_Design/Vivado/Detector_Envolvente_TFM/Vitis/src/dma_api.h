...
#define NUM_OF_WORDS 64  // Cambiado
#define FRAME_COUNT_MAX 576000-1 // 524288 // MCM of 9 and 64

#define OFFSET_MEM_WRITE 0x00A00000 // Memory write offset
...
// Inside dma_api.h (around line 40)
